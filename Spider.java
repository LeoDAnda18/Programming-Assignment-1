 ...
 * The source is the third link in your PA1 reference link announcement.
...
public class Spider
{
  private static final int MAX_PAGES_TO_SEARCH = 31; // Makes a full heap of height 5
     ...
     while(this.pagesVisited.size() < MAX_PAGES_TO_SEARCH) //My program searches for 31 urls, so we cap it at 31.
      {
          ...
          if(this.pagesToVisit.isEmpty()) // checks if there is any more pages to visit.
          {
              ...
              this.pagesVisited.add(url); //says you visited that page.
          }
          else
          {
